...
int main()
{
  ...
  // tests the accumulate() function
  std::string acc_test;
  std::cout << "This is the accumulation of set1: " << set1.accumulate(acc_test) << std::endl;
  acc_test.clear();
  std::cout << "This is the accumulation of set2: " << set2.accumulate(acc_test) << std::endl;
  acc_test.clear();
