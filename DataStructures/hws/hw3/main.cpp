...
void StudentTests()
{
  ...
  assert(ja.numElementsInBin(5) == 0);
  assert(ja.numElementsInBin(6) == 1);
  assert(ja.getElement(1, 0) == 9);
  assert(ja.getElement(1, 1) == 12);
  assert(ja.getElement(1, 2) == 45);
  assert(ja.getElement(3, 0) == 90);
  assert(ja.getElement(3, 1) == 21312);
  assert(ja.getElement(6, 0) == 75);
  ...
  assert(ja.getElement(3, 0) == 90);
  assert(ja.getElement(3, 1) == 21312);
  assert(ja.getElement(3, 2) == 32);
  assert(ja.getElement(6, 0) == 75);

  // remove 12 and verify
  ja.removeElement(1, 1);
